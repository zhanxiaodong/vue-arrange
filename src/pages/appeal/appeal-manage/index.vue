...
.appeal-manage
  ...
  el-form.mt20(
    ...
    el-form-item(label="风格标签" required) 
      el-select(v-model="form.style" filterable allow-create clearable)
    ...
    el-form-item(label="材质" required)
      el-select(v-model="form.me" filterable allow-create clearable)
    ...
    el-form-item(label="场景" required)
      el-select(v-model="form.scene" filterable allow-create clearable)
    ...
    el-form-item(label="季节" required)
      el-select(v-model="form.season" filterable allow-create clearable)
    ...
    el-form-item(label="属性" required)
      el-select(v-model="form.attr"  filterable allow-create clearable)
