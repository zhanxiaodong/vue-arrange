        ...
        el-table.wfull(:data="form.goodsList" v-model="form.goodsList")
          ...
          el-table-column(label="操作") 
            template(slot-scope="scope")
              ...
              el-button(type="success" icon="el-icon-download" size="mini" circle @click="downloadQr(scope.$index)" )
              //el-button(type="info"  icon="el-icon-download" size="mini" circle disabled)
            //template(slot-scope="scope")
