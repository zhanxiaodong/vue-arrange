<template>
    <div class="container">
        <div class="left-header">
            <el-button type="info" round>本周</el-button>
            <el-button type="info" round>本月</el-button>
            <el-button type="info" round>季度</el-button>
        </div>
         <div class="guest">   
     ...
     <div class="shopping">
        ...
        <div id="other" :style="{width: '500px', height: '300px'}"></div>
     </div>
     <div class="profit">
