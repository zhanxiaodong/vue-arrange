<template lang="pug">
.shipping-address-manage.pl15.pr15
  el-row
    el-col(:span="24")
      el-button.pull-right(type="success" @click="edit({}, 'add')") 新建邮寄地址
  el-row.mt20
    el-col(:span="24")
      ...
      el-col(v-bind:span="16"
        ...
        el-form.mt20(
          ...
          el-form-item(label="收件人" prop="addresseeName")
            el-input(v-model="editAddress.addresseeName" placeholder="收件人")
          el-form-item(label="联系电话" prop="addresseePhone")
            el-input(v-model="editAddress.addresseePhone" placeholder="联系电话")
          el-form-item(label="邮编" prop="zipCode")
            el-input(v-model="editAddress.zipCode" placeholder="邮编")
...
<script>
import { validatePhone, validateZipCode } from '@/common/rules'
  ...
  methods: {
    ...
    edit (address, type) {
      ...
      if (type === 'add') {
        ...
        this.editAddress.title = '新建邮寄地址'
        this.editAddress.id = null
        this.editAddress.addresseeName = null
        this.editAddress.addresseePhone = null
        this.editAddress.remark = null
        this.editAddress.zipCode = null
        ...
        this.editAddress.title = '编辑邮寄地址'
        this.editAddress.id = address.id
        this.editAddress.addresseeName = address.name
        this.editAddress.addresseePhone = address.tel
        this.editAddress.remark = address.remark
        this.editAddress.zipCode = address.code
     ...
     */
    save () {
      if (!this.editAddress.addresseeName) {
        this.$message.error('请输入收件人名称')
        return
      }
      if (!this.editAddress.addresseePhone) {
      ...
      this.$axios.post(this.$apis.address.addAddress, {
        ...
        name: this.editAddress.addresseeName,
        tel: this.editAddress.addresseePhone,
        code: this.editAddress.zipCode,
