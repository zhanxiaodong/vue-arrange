...
export default {
  ...
  //推送
  push: {
//	findPushMsgByType: `${api.java}/merchant_new/user/findPushMsgByType`,
//	pushMsg: `${api.java}/merchant_new/user/pushMsg`,
//	giveDiscount: `${api.java}/merchant_new/user/giveDiscount`,
  }
